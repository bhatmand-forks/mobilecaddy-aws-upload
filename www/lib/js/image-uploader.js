(function (AWS) {
  ...
  var defaultConfig = {
    accessKeyId: 'AKIAILIHDPXEIA42RZBQ',
    bucket: {},
    bucketName: 'toddhalfpenny',
    bucketUrl: 'https://s3.amazonaws.com/toddhalfpenny/',
    file: {},
    region: 'eu-west-1',
    secretAccessKey: 'Om1XJya1JxyALp3XCXBED4EqlU+pYyTikm08fRSv',
    sizeLimit: sizeLimit,
    uploadProgress: 0
  }
