describe("settings:", function() {
  ...
  var sideMenu = require('./sidemenu.page.js');
  ...
  it("should have a settings page", function() {
    ...
    browser.get('http://localhost:3030').then(function() {
      ...
      return browser.get('http://localhost:3030/www/#/app/settings' + localStr);
    }).then(function() {
  ...
  it("should have no upgrade available (as no upgrade available)", function() {
    browser.get('http://localhost:3030/www/#/app/home').then(function() {
      return browser.sleep(3 * sleepMultiplyer);
    }).then(function(){
     ...
     sideMenu.settingsMenuItem.click();
